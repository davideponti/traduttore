...
class Translator {
  ...
  _medicalOfflineTranslate(text) {
    ...
    const medicalDict = {
      ...
      'mi fa male il polso': 'My wrist hurts',
      'mi fa male la mano': 'My hand hurts',
      'mi fa male il dito': 'My finger hurts',
      'mi fa male il petto': 'My chest hurts',
      'mi fa male la schiena': 'My back hurts',
      'mi fa male la pancia': 'My stomach hurts',
      'mi fa male il fianco': 'My side hurts',
      'mi fa male la gamba': 'My leg hurts',
      'mi fa male il ginocchio': 'My knee hurts',
      'mi fa male la caviglia': 'My ankle hurts',
