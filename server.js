...
function getMedicalPhrases(lang, category) {
  const allPhrases = {
    it: [
      ...
      // Mi fa male [parte del corpo]
      { category: 'sintomi', text: 'Mi fa male la testa', translation: 'My head hurts' },
      { category: 'sintomi', text: 'Mi fa male il collo', translation: 'My neck hurts' },
      { category: 'sintomi', text: 'Mi fa male la spalla', translation: 'My shoulder hurts' },
      { category: 'sintomi', text: 'Mi fa male il braccio', translation: 'My arm hurts' },
      { category: 'sintomi', text: 'Mi fa male il gomito', translation: 'My elbow hurts' },
      { category: 'sintomi', text: 'Mi fa male il polso', translation: 'My wrist hurts' },
      { category: 'sintomi', text: 'Mi fa male la mano', translation: 'My hand hurts' },
      { category: 'sintomi', text: 'Mi fa male il dito', translation: 'My finger hurts' },
      { category: 'sintomi', text: 'Mi fa male il petto', translation: 'My chest hurts' },
      { category: 'sintomi', text: 'Mi fa male la schiena', translation: 'My back hurts' },
      { category: 'sintomi', text: 'Mi fa male la pancia', translation: 'My stomach hurts' },
      { category: 'sintomi', text: 'Mi fa male il fianco', translation: 'My side/hip hurts' },
      { category: 'sintomi', text: 'Mi fa male la gamba', translation: 'My leg hurts' },
      { category: 'sintomi', text: 'Mi fa male il ginocchio', translation: 'My knee hurts' },
      { category: 'sintomi', text: 'Mi fa male la caviglia', translation: 'My ankle hurts' },
      { category: 'sintomi', text: 'Mi fa male il piede', translation: 'My foot hurts' },
      { category: 'sintomi', text: 'Mi fa male tutto', translation: 'Everything hurts' },
