...
function getPatientResponses() {
  return [
    ...
    { english: 'The pain is sharp', italian: 'Il dolore è acuto', emoji: '\u{26A1}' },
    { english: 'The pain is burning', italian: 'Il dolore è bruciante', emoji: '\u{1F525}' },
    { english: 'The pain is stabbing', italian: 'Il dolore è lancinante', emoji: '\u{1F4A5}' },
    { english: 'The pain is dull', italian: 'Il dolore è sordo', emoji: '\u{1F634}' },
    { english: 'The pain comes and goes', italian: 'Il dolore va e viene', emoji: '\u{1F504}' },
    { english: 'It hurts when I move', italian: 'Fa male quando mi muovo', emoji: '\u{1F4AA}' },
    { english: 'It hurts when I breathe', italian: 'Fa male quando respiro', emoji: '\u{1FAC1}' },
    { english: 'It hurts more at night', italian: 'Fa male più la notte', emoji: '\u{1F303}' },
    { english: 'I have a burning sensation', italian: 'Ho una sensazione di bruciore', emoji: '\u{1F525}' },
    { english: 'I feel numbness', italian: 'Ho intorpidimento', emoji: '\u{1F9E2}' },
    { english: 'I feel tingling', italian: 'Ho formicolio', emoji: '\u{26A1}' },
    { english: 'My leg is swollen', italian: 'Ho la gamba gonfia', emoji: '\u{1F4A6}' },
    { english: 'My ankle is swollen', italian: 'Ho la caviglia gonfia', emoji: '\u{1F4A6}' },
    { english: 'I have a rash', italian: 'Ho un\'eruzione cutanea', emoji: '\u{1F9A1}' },
    { english: 'I have blisters', italian: 'Ho delle vesciche', emoji: '\u{1F9A1}' },
    { english: 'I have a bruise', italian: 'Ho un livido', emoji: '\u{1FAC5}' },
    { english: 'I have a cut', italian: 'Ho un taglio', emoji: '\u{1FAC0}' },
    { english: 'I have a scar', italian: 'Ho una cicatrice', emoji: '\u{1F9CD}' },
    { english: 'I have an infection', italian: 'Ho un\'infezione', emoji: '\u{1F9A0}' },
    { english: 'My wound hurts', italian: 'Mi fa male la ferita', emoji: '\u{1FA79}' },
    { english: 'My wound is bleeding', italian: 'La ferita sanguina', emoji: '\u{1FA78}' },
    { english: 'My throat hurts', italian: 'Mi fa male la gola', emoji: '\u{1F9AE}' },
    { english: 'My ear hurts', italian: 'Mi fa male l\'orecchio', emoji: '\u{1F442}' },
    { english: 'My eye hurts', italian: 'Mi fa male l\'occhio', emoji: '\u{1F440}' },
    { english: 'My hip hurts', italian: 'Mi fa male l\'anca', emoji: '\u{1F9B8}' },
    { english: 'My jaw hurts', italian: 'Mi fa male la mascella', emoji: '\u{1FAC0}' },
    { english: 'My tooth hurts', italian: 'Mi fa male il dente', emoji: '\u{1F9B7}' },
    { english: 'My ribs hurt', italian: 'Mi fanno male le costole', emoji: '\u{1F9B6}' },
    { english: 'I have cramps', italian: 'Ho i crampi', emoji: '\u{1F4AB}' },
    { english: 'I have chills', italian: 'Ho i brividi', emoji: '\u{1F32C}' },
    { english: 'I am sweating', italian: 'Sto sudando', emoji: '\u{1F4A6}' },
    { english: 'I feel itchy', italian: 'Mi prude', emoji: '\u{1F9A1}' },
    { english: 'I cannot swallow', italian: 'Non riesco a deglutire', emoji: '\u{1F934}' },
    { english: 'I cannot stand up', italian: 'Non riesco ad alzarmi', emoji: '\u{1F9D6}' },
    { english: 'I cannot move my arm', italian: 'Non riesco a muovere il braccio', emoji: '\u{1F9BE}' },
    { english: 'I cannot move my leg', italian: 'Non riesco a muovere la gamba', emoji: '\u{1F9B5}' },
    { english: 'I am constipated', italian: 'Ho la stitichezza', emoji: '\u{1F4A9}' },
    { english: 'I have diarrhea', italian: 'Ho la diarrea', emoji: '\u{1F4A9}' },
    { english: 'I have trouble urinating', italian: 'Ho difficoltà a urinare', emoji: '\u{1F6BD}' },
    { english: 'My urine is red', italian: 'La mia urina è rossa', emoji: '\u{1FA78}' },
    { english: 'My stool is black', italian: 'Le mie feci sono nere', emoji: '\u{26AB}' },
    { english: 'I have allergies', italian: 'Ho delle allergie', emoji: '\u{26A0}' },
    { english: 'I have asthma', italian: 'Ho l\'asma', emoji: '\u{1F9AC}' },
    { english: 'I have diabetes', italian: 'Ho il diabete', emoji: '\u{1F489}' },
    { english: 'I have epilepsy', italian: 'Ho l\'epilessia', emoji: '\u{1F9AC}' },
    { english: 'I have cancer', italian: 'Ho il cancro', emoji: '\u{1F9A1}' },
    { english: 'I have heart disease', italian: 'Ho una malattia al cuore', emoji: '\u{1F9E1}' },
    { english: 'I have kidney problems', italian: 'Ho problemi ai reni', emoji: '\u{1F9B1}' },
    { english: 'I have liver problems', italian: 'Ho problemi al fegato', emoji: '\u{1F9AC}' },
    { english: 'I have thyroid problems', italian: 'Ho problemi alla tiroide', emoji: '\u{1F9AC}' },
    { english: 'I am depressed', italian: 'Sono depresso', emoji: '\u{1F614}' },
    { english: 'I feel anxious', italian: 'Mi sento ansioso', emoji: '\u{1F630}' },
    { english: 'I feel confused', italian: 'Mi sento confuso', emoji: '\u{1F635}' },
    { english: 'I feel lonely', italian: 'Mi sento solo', emoji: '\u{1F622}' },
    { english: 'I want to call my family', italian: 'Voglio chiamare la mia famiglia', emoji: '\u{1F9D1}\u200D\u{1F9D1}\u200D\u{1F9D2}' },
    { english: 'I want to call my wife', italian: 'Voglio chiamare mia moglie', emoji: '\u{1F470}' },
    { english: 'I want to call my husband', italian: 'Voglio chiamare mio marito', emoji: '\u{1F470}' },
    { english: 'Where is my phone?', italian: 'Dov\'è il mio telefono?', emoji: '\u{1F4F1}' },
    { english: 'Where are my clothes?', italian: 'Dove sono i miei vestiti?', emoji: '\u{1F455}' },
    { english: 'How long will I stay?', italian: 'Per quanto tempo rimarrò?', emoji: '\u{23F0}' },
    { english: 'Will I need surgery?', italian: 'Avrò bisogno di un intervento?', emoji: '\u{1F52A}' },
    { english: 'When will the doctor come?', italian: 'Quando arriva il dottore?', emoji: '\u{1F468}\u200D\u{2695}\uFE0F' },
    { english: 'I am in pain', italian: 'Ho dolore', emoji: '\u{1F623}' },
    { english: 'Give me something for the pain', italian: 'Mi dia qualcosa per il dolore', emoji: '\u{1F48A}' },
    { english: 'I did not take my medicine', italian: 'Non ho preso la mia medicina', emoji: '\u{1F48A}' },
    { english: 'I need my glasses', italian: 'Ho bisogno dei miei occhiali', emoji: '\u{1F453}' },
    { english: 'I need my hearing aid', italian: 'Ho bisogno del mio apparecchio acustico', emoji: '\u{1F9BE}' },
    { english: 'I need my wheelchair', italian: 'Ho bisogno della mia sedia a rotelle', emoji: '\u{1F9BC}' },
    { english: 'I need crutches', italian: 'Ho bisogno delle stampelle', emoji: '\u{1F9B7}' },
    { english: 'Can I walk?', italian: 'Posso camminare?', emoji: '\u{1F9B5}' },
    { english: 'Can I eat?', italian: 'Posso mangiare?', emoji: '\u{1F37D}' },
    { english: 'Can I drink water?', italian: 'Posso bere acqua?', emoji: '\u{1F6B0}' },
    { english: 'I am feeling better today', italian: 'Oggi mi sento meglio', emoji: '\u{1F60A}' },
    { english: 'I am feeling worse today', italian: 'Oggi mi sento peggio', emoji: '\u{1F616}' },
    { english: 'What time is it?', italian: 'Che ore sono?', emoji: '\u{1F552}' },
    { english: 'What day is it?', italian: 'Che giorno è?', emoji: '\u{1F4C5}' },
    { english: 'Good morning', italian: 'Buongiorno', emoji: '\u{1F31E}' },
    { english: 'Good evening', italian: 'Buonasera', emoji: '\u{1F303}' },
    { english: 'Please', italian: 'Per favore', emoji: '\u{1F64F}' },
    { english: 'Excuse me', italian: 'Mi scusi', emoji: '\u{1F64F}' },
    { english: 'I am sorry', italian: 'Mi dispiace', emoji: '\u{1F64F}' },
    { english: 'I have COVID', italian: 'Ho il COVID', emoji: '\u{1F9A1}' },
    { english: 'I have the flu', italian: 'Ho l\'influenza', emoji: '\u{1F927}' },
    { english: 'I have a cold', italian: 'Ho il raffreddore', emoji: '\u{1F927}' },
    { english: 'I have a sore throat', italian: 'Ho il mal di gola', emoji: '\u{1F9AE}' },
    { english: 'I have an earache', italian: 'Ho il mal d\'orecchi', emoji: '\u{1F442}' },
    { english: 'My nose is bleeding', italian: 'Mi sanguina il naso', emoji: '\u{1F9F9}' },
    { english: 'I have a broken bone', italian: 'Ho un osso rotto', emoji: '\u{1F9B4}' },
    { english: 'I think I broke something', italian: 'Penso di aver rotto qualcosa', emoji: '\u{1F4A2}' },
    { english: 'I was hit by a car', italian: 'Sono stato investito da una macchina', emoji: '\u{1F697}' },
    { english: 'I was in a car accident', italian: 'Ho avuto un incidente d\'auto', emoji: '\u{1F697}' },
    { english: 'I was assaulted', italian: 'Sono stato aggredito', emoji: '\u{1F4A2}' },
    { english: 'I was burned', italian: 'Mi sono ustionato', emoji: '\u{1F525}' },
    { english: 'I was bitten by a dog', italian: 'Sono stato morso da un cane', emoji: '\u{1F415}' },
    { english: 'I was bitten by an insect', italian: 'Sono stato punto da un insetto', emoji: '\u{1F41B}' },
    { english: 'I was stung by a bee', italian: 'Sono stato punto da un\'ape', emoji: '\u{1F41D}' },
    { english: 'I have food poisoning', italian: 'Ho un\'intossicazione alimentare', emoji: '\u{1F922}' },
    { english: 'I drank too much alcohol', italian: 'Ho bevuto troppo alcol', emoji: '\u{1F37A}' },
    { english: 'I have a headache', italian: 'Ho mal di testa', emoji: '\u{1F915}' },
    { english: 'I have a migraine', italian: 'Ho l\'emicrania', emoji: '\u{1F915}' },
    { english: 'My vision is blurry', italian: 'La mia vista è offuscata', emoji: '\u{1F440}' },
    { english: 'I see double', italian: 'Vedo doppio', emoji: '\u{1F440}' },
  ];
...
function getMedicalPhrases(lang, category) {
  const allPhrases = {
    it: [
      ...
      { category: 'accoglienza', text: 'Si sieda, si metta comodo', translation: 'Sit down, make yourself comfortable' },
      { category: 'accoglienza', text: 'Benvenuto nel nostro reparto', translation: 'Welcome to our ward' },
      { category: 'accoglienza', text: 'Mi dica se ha bisogno di qualcosa', translation: 'Tell me if you need anything' },
      { category: 'accoglienza', text: 'La sua stanza è la numero...', translation: 'Your room is number...' },
      { category: 'accoglienza', text: 'Le spiego cosa faremo oggi', translation: 'Let me explain what we will do today' },
      { category: 'accoglienza', text: 'Ha già firmato il consenso informato?', translation: 'Have you already signed the informed consent?' },
      { category: 'accoglienza', text: 'Ha qualche domanda prima di iniziare?', translation: 'Do you have any questions before we start?' },
      ...
      { category: 'sintomi', text: 'Il dolore è peggiorato?', translation: 'Has the pain gotten worse?' },
      { category: 'sintomi', text: 'Ha dolori articolari?', translation: 'Do you have joint pain?' },
      { category: 'sintomi', text: 'Ha mal di testa?', translation: 'Do you have a headache?' },
      { category: 'sintomi', text: 'Ha perduto conoscenza?', translation: 'Have you lost consciousness?' },
      { category: 'sintomi', text: 'Ha avuto convulsioni?', translation: 'Have you had seizures?' },
      { category: 'sintomi', text: 'Ha la pressione alta?', translation: 'Do you have high blood pressure?' },
      { category: 'sintomi', text: 'Ha il diabete?', translation: 'Do you have diabetes?' },
      { category: 'sintomi', text: 'Ha avuto un infarto?', translation: 'Have you had a heart attack?' },
      { category: 'sintomi', text: 'Ha avuto un ictus?', translation: 'Have you had a stroke?' },
      { category: 'sintomi', text: 'Ha problemi di cuore?', translation: 'Do you have heart problems?' },
      { category: 'sintomi', text: 'Ha avuto un incidente?', translation: 'Have you had an accident?' },
      { category: 'sintomi', text: 'Ha mangiato qualcosa di diverso?', translation: 'Have you eaten anything different?' },
      { category: 'sintomi', text: 'Ha preso qualche farmaco?', translation: 'Have you taken any medication?' },
      { category: 'sintomi', text: 'Da quando si sente così?', translation: 'Since when do you feel this way?' },
      { category: 'sintomi', text: 'Ha dolore quando tossisce?', translation: 'Does it hurt when you cough?' },
      { category: 'sintomi', text: 'Ha dolore quando urina?', translation: 'Does it hurt when you urinate?' },
      { category: 'sintomi', text: 'Ha sangue nelle feci?', translation: 'Do you have blood in your stool?' },
      { category: 'sintomi', text: 'Vomita spesso?', translation: 'Do you vomit often?' },
      { category: 'sintomi', text: 'Ha la febbre alta?', translation: 'Do you have high fever?' },
      { category: 'sintomi', text: 'Ha perso l\'appetito?', translation: 'Have you lost your appetite?' },
      { category: 'sintomi', text: 'Ha problemi di digestione?', translation: 'Do you have digestion problems?' },
      { category: 'sintomi', text: 'Ha avuto allergie?', translation: 'Have you had allergic reactions?' },
      ...
      { category: 'corpo', text: 'Ha dolore al collo?', translation: 'Do you have neck pain?' },
      { category: 'corpo', text: 'Ha dolore alla spalla?', translation: 'Do you have shoulder pain?' },
      { category: 'corpo', text: 'Ha dolore al ginocchio?', translation: 'Do you have knee pain?' },
      { category: 'corpo', text: 'Ha dolore alla gamba?', translation: 'Do you have leg pain?' },
      { category: 'corpo', text: 'Ha dolore al polso?', translation: 'Do you have wrist pain?' },
      { category: 'corpo', text: 'Ha dolore al gomito?', translation: 'Do you have elbow pain?' },
      { category: 'corpo', text: 'Ha dolore al fianco?', translation: 'Do you have side pain?' },
      { category: 'corpo', text: 'Ha dolore alla caviglia?', translation: 'Do you have ankle pain?' },
      { category: 'corpo', text: 'Ha dolore al piede?', translation: 'Do you have foot pain?' },
      { category: 'corpo', text: 'Ha dolore ai denti?', translation: 'Do you have tooth pain?' },
      { category: 'corpo', text: 'Ha dolore alla gola?', translation: 'Do you have a sore throat?' },
      { category: 'corpo', text: 'Ha dolore all\'orecchio?', translation: 'Do you have ear pain?' },
      { category: 'corpo', text: 'Ha dolore all\'occhio?', translation: 'Do you have eye pain?' },
